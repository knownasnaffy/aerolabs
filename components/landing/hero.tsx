...
const HeroSection = () => {
  return (
    <div className="container mx-auto min-h-screen grid place-items-center py-16 gap-4 lg:grid-cols-2 ">
      <div
        className={cn(
          "flex flex-col"
      ...
      >
        ...
        <div className="flex gap-2 mt-4">
          <Link
            href={"/courses"}
            className="button px-6 h-12 bg-blue-500 rounded-lg cursor-pointer select-none active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] active:border-b-[0px] transition-all duration-150 [box-shadow:0_10px_0_0_#1b6ff8,0_15px_0_0_#1b70f841] border-b-[1px] border-blue-400 hover:translate-y-[2px]"
          >
          ...
          <Link
            href={"/courses"}
            className="button px-6 h-12 bg-neutral rounded-lg cursor-pointer select-none active:translate-y-2 active:[box-shadow:0_0px_0_0_#445366,0_0px_0_0_#44536641] active:border-b-[0px] transition-all duration-150 [box-shadow:0_10px_0_0_#445366,0_15px_0_0_#44536641] border-b-[1px] border-neutral hover:translate-y-[2px]"
          >
